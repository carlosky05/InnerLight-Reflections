const traducciones = {
  es: {
    ...
    inExplicacion: "Cuando puedes hablar de tus sentimientos con alguien en quien confías, se vuelven menos aterradores y abrumadores.",
    inContacto: "Ponte en contacto con nosotros →",
    inPresentacion:
    ...
    seIntroducion:
      "Soy una terapeuta que ofrece un enfoque creativo y siempre apoyo a mis clientes con mucha compasión y comprensión, sin importar las dificultades que estén enfrentando.",
    seIntroducion2: "Me especializo en las siguientes áreas:",
    ...
    seFaq1A:"Sí. No importa si estás en Madrid, Nueva York, Barcelona o Miami: nos vemos por videollamada en un espacio seguro y privado, sin desplazamientos ni estrés extra.",
  ...
  en: {
    ...
    seIntroducion:
      "I am a therapist who offers a creative approach and always supports my clients with compassion and understanding, no matter the challenges they are facing.",
    seIntroducion2: "I specialize in the following areas:",
    ...
    seFaq1A:"Yes. Whether you are in Madrid, New York, Barcelona, or Miami, we meet via video call in a safe and private space, with no travel or extra stress.",
    ...
    seFaq3A:"Yes, sessions can be conducted in either Spanish or English, according to your preference.",
...
function detectarIdiomaUsuario() {
  if (!localStorage.getItem("idioma")) {
    ...
    const idioma = (langCode === "en" || langCode === "es") ? langCode : "es";
...
function cambiarIdioma() {
  ...
  localStorage.setItem("idioma", actual === "es" ? "en" : "es");
  aplicarIdioma();
}

window.addEventListener("DOMContentLoaded", () => {
  detectarIdiomaUsuario();
  aplicarIdioma();
